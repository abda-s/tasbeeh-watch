...
static const char *PHRASE_SUBHAN =
    "\330\263\330\250\330\255\330\247\331\206 "
    "\330\247\331\204\331\204\331\207";
static const char *PHRASE_HAMD =
    "\330\247\331\204\330\255\331\205\330\257 "
    "\331\204\331\204\331\207";
static const char *PHRASE_AKBAR =
    "\330\247\331\204\331\204\331\207 "
    "\330\243\331\203\330\250\330\261";
    ...
    for (int i = 0; i < TASBEEH_PHRASES; i++) {
        if (tasbeeh_dots[i]) {
            lv_obj_set_style_bg_color(tasbeeh_dots[i],
                (i == tasbeeh_phrase_idx) ? color_blue : color_gold, 0);
...
static void tasbeeh_tap_cb(lv_event_t *e)
{
    ...
    if (tasbeehCount >= (uint32_t)TASBEEH_TARGET) {
        ...
        prefs.putInt("tasbeeh_phrase", tasbeeh_phrase_idx);
    }
...
void create_screen_tasbeeh(void)
{
    ...
    lv_obj_set_style_arc_color(tasbeeh_arc, lv_color_hex(0x0e1a28), LV_PART_MAIN);
    ...
    lv_obj_set_style_arc_color(tasbeeh_arc, color_blue, LV_PART_INDICATOR);
    ...
    lv_obj_set_style_text_font(tasbeeh_title_label, &font_alexandria_16, 0);
    lv_obj_set_style_text_color(tasbeeh_title_label, color_blue, 0);
    ...
    lv_obj_set_style_text_font(tasbeeh_phrase_label, &font_alexandria_28, 0);
    ...
    lv_obj_set_style_text_font(tasbeeh_count_label, &font_reem_kufi_48, 0);
    ...
    lv_obj_set_style_text_font(tasbeeh_of_label, &font_alexandria_12, 0);
    ...
    lv_label_set_text(tasbeeh_of_label,
